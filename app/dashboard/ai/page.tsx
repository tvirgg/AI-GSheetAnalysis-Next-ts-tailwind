        ...
        <div className="flex-1 flex flex-col lg:pl-72">
          ...
          <main className="py-10 flex-1 overflow-auto">
            <div className="px-2 sm:px-4 lg:px-8">
              {/* Header Section */}
              <div className='px-2 sm:px-3 flex flex-col'>
                <div className='md:mx-20 px-2 sm:px-3 flex flex-row items-center'>
                  {/* Оригинальный SVG */}
                ...
                <p className='my-4 mx-6 md:mx-20'>
              ...
              {/* Вопросы */}
              <div className=" md:px-20 text-[14px] w-full py-5 my-10 grid grid-cols-1 sm:grid-cols-2 gap-6 sm:py-[65px] md:py-[45px] md:my-20 lg:py-[45px]">
              ...
              {/* Поле ввода и кнопка */}
              <div className="mt-14 mx-4 md:mx-20 flex flex-row items-center space-x-2 sm:space-x-4 md:pt-[15px] lg:pt-[1px] xl:pt-[5px] 2xl:pt-[85px]">
                <input
                  type="text"
                  placeholder="Введите запрос"
                  className="border p-2 flex-1 rounded focus:outline-none focus:ring-2 focus:ring-gray-300"
                />
              ...
              {/* Селект источника */}
              <div className="my-5 mx-4 md:mx-20 flex sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2">
                <label htmlFor="source" className="font-semibold whitespace-nowrap">
                  Источник:
                </label>
